...
public class SchoolListPresenter implements ISchoolListPresenter {
    private static final String TAG =  "SchoolListPresenter";
    ...
    private void getSchoolDetailsData() {
        ...
        call.enqueue(new Callback<List<SchoolDetailModel>>() {
            ...
            public void onResponse(Call<List<SchoolDetailModel>> call, Response<List<SchoolDetailModel>> response) {
                ...
                final ArrayMap<String, SchoolDetailModel> validUsersForAPICall = new ArrayMap<>();
                for(SchoolDetailModel schoolDetailModel : response.body()) {
                    validUsersForAPICall.put(schoolDetailModel.getDbn(), schoolDetailModel);
                }
                detailsResponse.onSuccess(validUsersForAPICall);
            }
